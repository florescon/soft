    ...
    if (type == 'basic') {
      ...
      const swalWithBootstrapButtons = Swal.mixin({
        customClass: {
          ...
          cancelButton: 'inline-block px-6 py-3 mb-4 font-bold text-center uppercase align-middle transition-all border-0 rounded-lg cursor-pointer hover:scale-102 active:opacity-85 hover:shadow-soft-xs bg-gradient-red leading-pro text-size-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 text-white'
        }
      });
