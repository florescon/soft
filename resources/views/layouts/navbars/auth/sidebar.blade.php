      ...
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">@lang('Foods')</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (Request::is('ingredients') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">@lang('Ingredients')</span>
          </a>
        </li>
